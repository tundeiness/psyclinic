...
ActiveRecord::Schema[7.1].define(version: 2026_02_01_000024) do
  ...
  create_table "app_settings", force: :cascade do |t|
    ...
    t.string "current_contract_version", default: "v1-2026", null: false
  end
  ...
  create_table "client_contracts", force: :cascade do |t|
    ...
    t.integer "signature_method", null: false
    t.datetime "signed_at", null: false
    t.string "electronic_signature_name"
    t.string "signed_from_ip"
    t.string "sponsor_name"
    t.string "sponsor_signature_typed"
    t.bigint "certified_by_user_id"
    t.datetime "certified_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["certified_by_user_id"], name: "index_client_contracts_on_certified_by_user_id"
    t.index ["client_profile_id", "contract_version"], name: "idx_client_contracts_lookup"
    t.index ["client_profile_id"], name: "index_client_contracts_on_client_profile_id"
  end
  ...
  add_foreign_key "client_contracts", "client_profiles", on_delete: :cascade
