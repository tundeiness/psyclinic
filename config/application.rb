...
module PsyClinic
  class Application < Rails::Application
    ...
    # Active Storage: local disk in all environments for this MVP. Swap
    # `:local` for an S3/GCS service in config/storage.yml + per-env
    # config.active_storage.service when moving to cloud storage.
